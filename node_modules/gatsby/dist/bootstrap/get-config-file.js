        ...
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            if (!testRequireError(configPath, _context.t0)) {
              ...
              console.log(``);
              report.error(`Your gatsby-config.js file is in the wrong place. You've placed in the src/ directory. It must instead be at the root of your site next to your package.json file.`);
              console.log(``);
              process.exit(1);
            }
